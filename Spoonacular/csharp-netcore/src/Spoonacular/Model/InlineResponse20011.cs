...
namespace Spoonacular.Model
{
    ...
    public partial class InlineResponse20011 : IEquatable<InlineResponse20011>, IValidatableObject
    {
        ...
        public InlineResponse20011(List<InlineResponse20011Ingredients> ingredients = default(List<InlineResponse20011Ingredients>))
        {
            // to ensure "ingredients" is required (not null)
            if (ingredients == null)
            {
                throw new ArgumentNullException("ingredients is a required property for InlineResponse20011 and cannot be null");
            }
        ...
        public List<InlineResponse20011Ingredients> Ingredients { get; set; }
