...
namespace Spoonacular.Model
{
    ...
    public partial class InlineResponse20013 : IEquatable<InlineResponse20013>, IValidatableObject
    {
        ...
        public InlineResponse20013(List<InlineResponse20013ParsedInstructions> parsedInstructions = default(List<InlineResponse20013ParsedInstructions>), List<InlineResponse20013Ingredients1> ingredients = default(List<InlineResponse20013Ingredients1>), List<InlineResponse20013Ingredients1> equipment = default(List<InlineResponse20013Ingredients1>))
        {
            // to ensure "parsedInstructions" is required (not null)
            if (parsedInstructions == null)
            {
                throw new ArgumentNullException("parsedInstructions is a required property for InlineResponse20013 and cannot be null");
            }
            this.ParsedInstructions = parsedInstructions;
            // to ensure "ingredients" is required (not null)
            if (ingredients == null)
            {
                throw new ArgumentNullException("ingredients is a required property for InlineResponse20013 and cannot be null");
            }
            this.Ingredients = ingredients;
            // to ensure "equipment" is required (not null)
            if (equipment == null)
            {
                throw new ArgumentNullException("equipment is a required property for InlineResponse20013 and cannot be null");
            }
