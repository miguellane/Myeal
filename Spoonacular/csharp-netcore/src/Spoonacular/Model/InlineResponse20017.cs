...
namespace Spoonacular.Model
{
    ...
    public partial class InlineResponse20017 : IEquatable<InlineResponse20017>, IValidatableObject
    {
        ...
        public InlineResponse20017(string cuisine = default(string), List<string> cuisines = default(List<string>), decimal confidence = default(decimal))
        {
            // to ensure "cuisine" is required (not null)
            if (cuisine == null)
            {
                throw new ArgumentNullException("cuisine is a required property for InlineResponse20017 and cannot be null");
            }
            this.Cuisine = cuisine;
            // to ensure "cuisines" is required (not null)
            if (cuisines == null)
            {
                throw new ArgumentNullException("cuisines is a required property for InlineResponse20017 and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "cuisine", IsRequired = true, EmitDefaultValue = false)]
