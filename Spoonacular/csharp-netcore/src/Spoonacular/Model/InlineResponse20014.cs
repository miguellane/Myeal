...
namespace Spoonacular.Model
{
    ...
    public partial class InlineResponse20014 : IEquatable<InlineResponse20014>, IValidatableObject
    {
        ...
        public InlineResponse20014(int id = default(int), string summary = default(string), string title = default(string))
        {
            this.Id = id;
            // to ensure "summary" is required (not null)
            if (summary == null)
            {
                throw new ArgumentNullException("summary is a required property for InlineResponse20014 and cannot be null");
            }
            this.Summary = summary;
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for InlineResponse20014 and cannot be null");
            }
            this.Title = title;
        }
